    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 '>
        <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                ...
                <ImageIcon className='h-4 w-4 text-muted-foreground'></ImageIcon>
            </CardHeader>
            <CardContent>
        ...
        <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                ...
                <LayersIcon className='h-4 w-4 text-muted-foreground'></LayersIcon>
            </CardHeader>
            <CardContent>
                <div className='text-2xl font-bold '>
                    {modelCount}
        ...
        <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                ...
                <ZapIcon className='h-4 w-4 text-muted-foreground'></ZapIcon>
            </CardHeader>
            <CardContent>
                <div className='text-2xl font-bold '>
