  ...
  return (
    <section id="pricing" className='w-full bg-muted flex flex-col items-center justify-center'>
      ...
      <AnimatedGradientText>
        <span
        className={cn(
            `inline animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#9cf0ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text 
            text-transparent`,
        )}
        >
            Price
                    ...
                    products.map(product => {
                        ...
                        return <div key={product.id} className={cn('border bg-background rounded-xl shadow-sm h-fit divide-y divide-border',
                            ...
                            <div className='p-6'>
                                ...
                                variant={product?.name?.toLowerCase() === mostPopularProduct.toLowerCase() ? "default" : "secondary"}>Subscribe</Button>
                                </Link>
                            </div>
